        ...
        <form class="interview-form" id="create_interview" action="/interview/create" method="post" novalidate>
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" name="firstname" id="firstname" value="<?php echo e(session()->getOldInput()['firstname'] ?? ''); ?>" maxlength="20">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    ...
                    <select name="maritalStatus" class="form-control" id="maritalStatus">
                        ...
                        <option value=0
                        <?php echo e((isset(session()->getOldInput()['maritalStatus']) && session()->getOldInput()['maritalStatus'] == 0) ? 'selected' : ''); ?>>مجرد</option>
                        <option value=1
                        <?php echo e((isset(session()->getOldInput()['maritalStatus']) && session()->getOldInput()['maritalStatus'] == 1) ? 'selected' : ''); ?>>متاهل</option>
                        <option value=2
                        <?php echo e((isset(session()->getOldInput()['maritalStatus']) && session()->getOldInput()['maritalStatus'] == 2) ? 'selected' : ''); ?>>نامزد</option>
                        <option value=3
                        <?php echo e((isset(session()->getOldInput()['maritalStatus']) && session()->getOldInput()['maritalStatus'] == 3) ? 'selected' : ''); ?>>مطلقه</option>
                    </select>
                ...
                <div class="col-md-2">
                    ...
                    <option value="" disabled selected>کاربری کامپیوتر</option>
                        <option value=0
                        <?php echo e((isset(session()->getOldInput()['computerSkill']) && session()->getOldInput()['computerSkill'] == 0) ? 'selected' : ''); ?>>صفر</option>
                        <option value=1
                        <?php echo e((isset(session()->getOldInput()['computerSkill']) && session()->getOldInput()['computerSkill'] == 1) ? 'selected' : ''); ?>>کم</option>
                        <option value=2
                        <?php echo e((isset(session()->getOldInput()['computerSkill']) && session()->getOldInput()['computerSkill'] == 2) ? 'selected' : ''); ?>>متوسط</option>
                        <option value=3
                        <?php echo e((isset(session()->getOldInput()['computerSkill']) && session()->getOldInput()['computerSkill'] == 3) ? 'selected' : ''); ?>>حرفه ای</option>
                    </select>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="internship" id="internship" class="form-control">
                        ...
                        <option value="1"
                        <?php echo e((isset(session()->getOldInput()['internship']) && session()->getOldInput()['internship'] == 1) ? 'selected' : ''); ?>>بله</option>
                        <option value="0"
                        <?php echo e((isset(session()->getOldInput()['internship']) && session()->getOldInput()['internship'] == 0) ? 'selected' : ''); ?>>خیر</option>
                    </select>
                    <div class="invalid-feedback" id="error-reasonForJob"></div>
                </div>
            ...
            <div class="row mt-3">
                <div class="col-md-4">
                    ...
                    <select name="knowAboutUs" id="knowAboutUs" class="form-control">
                        ...
                        <option value=1
                        <?php echo e((isset(session()->getOldInput()['knowAboutUs']) && session()->getOldInput()['knowAboutUs'] == 1) ? 'selected' : ''); ?>>بله</option>
                        <option value=0
                        <?php echo e((isset(session()->getOldInput()['knowAboutUs']) && session()->getOldInput()['knowAboutUs'] == 0) ? 'selected' : ''); ?>>خیر</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <option value="" disabled selected>انتخاب کنید</option>
                        <option value=1
                        <?php echo e((isset(session()->getOldInput()['haveFriendHere']) && session()->getOldInput()['haveFriendHere'] == 1) ? 'selected' : ''); ?>>بله</option>
                        <option value=0
                        <?php echo e((isset(session()->getOldInput()['haveFriendHere']) && session()->getOldInput()['haveFriendHere'] == 0) ? 'selected' : ''); ?>>خیر</option>
                    </select>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="characterType" id="characterType" class="form-control">
                        <option value="" disabled selected> انتخاب کنید</option>
                        <option value=1
                        <?php echo e((isset(session()->getOldInput()['characterType']) && session()->getOldInput()['characterType'] == 1) ? 'selected' : ''); ?>>درون گرا</option>
                        <option value=0
                        <?php echo e((isset(session()->getOldInput()['characterType']) && session()->getOldInput()['characterType'] == 0) ? 'selected' : ''); ?>>برون گرا</option>
                    </select>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                    ...
                    <option value="" disabled selected> انتخاب کنید</option>
                        <option value=0
                        <?php echo e((isset(session()->getOldInput()['englishLevel']) && session()->getOldInput()['englishLevel'] == 0) ? 'selected' : ''); ?>>صفر</option>
                        <option value=1
                        <?php echo e((isset(session()->getOldInput()['englishLevel']) && session()->getOldInput()['englishLevel'] == 1) ? 'selected' : ''); ?>>کم</option>
                        <option value=2
                        <?php echo e((isset(session()->getOldInput()['englishLevel']) && session()->getOldInput()['englishLevel'] == 2) ? 'selected' : ''); ?>>متوسط</option>
                        <option value=3
                        <?php echo e((isset(session()->getOldInput()['englishLevel']) && session()->getOldInput()['englishLevel'] == 3) ? 'selected' : ''); ?>>حرفه ای</option>
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <option value="" disabled selected> انتخاب کنید</option>
                        <option value=1
                        <?php echo e((isset(session()->getOldInput()['migrateIntention']) && session()->getOldInput()['migrateIntention'] == 1) ? 'selected' : ''); ?>>بله</option>
                        <option value=0
                        <?php echo e((isset(session()->getOldInput()['migrateIntention']) && session()->getOldInput()['migrateIntention'] == 0) ? 'selected' : ''); ?>>خیر</option>
                    </select>
                </div>
